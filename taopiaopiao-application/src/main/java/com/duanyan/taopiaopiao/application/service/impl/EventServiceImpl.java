...
import com.duanyan.taopiaopiao.domain.dto.EventResponse.TicketTierDTO;
...
public class EventServiceImpl implements EventService {
    ...
    public EventPageResponse getEventPage(EventQueryRequest request) {
        ...
        IPage<Event> eventPage = eventRepository.page(page, queryWrapper);
     ...
     * 转换票档实体列表为DTO列表
     */
    private List<TicketTierDTO> convertToTicketTierDTOList(List<TicketTier> ticketTiers) {
        return ticketTiers.stream()
                .map(tier -> TicketTierDTO.builder()
                        .id(tier.getId())
                        .name(tier.getName())
