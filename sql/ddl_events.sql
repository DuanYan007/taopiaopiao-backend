CREATE TABLE events (
  ...
  type VARCHAR(20) NOT NULL COMMENT '演出类型: concert, theatre, exhibition, sports, music, kids, dance',
  ...
  status VARCHAR(20) NOT NULL DEFAULT 'draft' COMMENT '状态: draft, on_sale, off_sale, sold_out, coming_soon',
